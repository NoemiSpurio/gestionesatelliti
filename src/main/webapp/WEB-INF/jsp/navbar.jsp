        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdown07">
              ...
              <li><a class="dropdown-item" href="${pageContext.request.contextPath}/satellite/search">Cerca</a></li>
              <li><a class="dropdown-item" href="${pageContext.request.contextPath}/satellite/insert">Inserisci</a></li>
            </ul> 
          </li>   
        </ul>
      </div>
